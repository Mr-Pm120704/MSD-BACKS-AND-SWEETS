const fallbackProducts = {
  milk: {
    id: 'milk', name: 'Milk Products', icon: '🥛', emoji: '☕', color: '#F4A261', timeRestricted: false,
    items: [
  ...
  drinks: {
    id: 'drinks', name: 'Choose (Drinks)', icon: '🥤', emoji: '🧊', color: '#2EC4B6', timeRestricted: false,
    subCategories: {
      backed: {
        name: 'Backed / Bottled',
        items: [
  ...
  snacks: {
    id: 'snacks', name: 'Snacks', icon: '🍿', emoji: '🥨', color: '#E76F51', timeRestricted: false,
    items: [
  ...
  chocolates: {
    id: 'chocolates', name: 'Chocolates', icon: '🍫', emoji: '🍫', color: '#6D4C41', timeRestricted: false,
    items: [
      ...
      { id: 'c8', name: 'Eclairs', price: 5, desc: 'Toffee chocolate candy', emoji: '🍬', popular: true },
    ]
  },
  cakes: {
    id: 'cakes', name: 'Cakes', icon: '🎂', emoji: '🎂', color: '#E91E8C', timeRestricted: false,
    items: [
  ...
  meals: {
    id: 'meals', name: 'Meals', icon: '🍽️', emoji: '🍛', color: '#43A047', timeRestricted: true, availableAfter: 18,
    items: [
  ...
  junkfoods: {
    id: 'junkfoods', name: 'Junk Foods & Buns', icon: '🍞', emoji: '🥐', color: '#FB8C00', timeRestricted: false,
    items: [
  ...
  sweets: {
    id: 'sweets', name: 'Sweets', icon: '🍬', emoji: '🍯', color: '#AB47BC', timeRestricted: false,
    items: [
...
export { fallbackProducts as PRODUCTS, SHOP_INFO };
